...
class TUSimpleDataset(BaseDataSet):
    ...
    def __init__(self, **kwargs):
        ...
        super(TUSimpleDataset, self).__init__(**kwargs)

    def _set_files(self):
        self.root = os.path.join(self.root, 'testing')
        self.image_dir = os.path.join(self.root, 'gt_image')
...
class TUSimple(BaseDataLoader):
    def __init__(self, data_dir, batch_size, split, crop_size=None, base_size=None, scale=True, num_workers=1,
        ...
        super(TUSimple, self).__init__(self.dataset, batch_size, shuffle, num_workers, val_split)
